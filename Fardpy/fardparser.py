...
class Parser:
  ...
  def primary(self):
    ...
    elif self.cur.type == "CALLFUNC":
      self.eat("CALLFUNC")
      name = self.eat("IDENTIFIER")

      return FunctionCall(name)

    elif self.cur.type == "NULL":
      return NullLiteral()
  ...
  def expr(self):
    ...
    elif self.cur.type == "KEYWORD" and self.cur.value == "fard-in":
      self.eat("KEYWORD")
      name = None
      if self.cur.type == "STRING": name = self.eat("STRING")
      else: name = self.eat("IDENTIFIER")
    ...
    elif self.cur.type == "KEYWORD" and self.cur.value == "fard-back":
      self.eat("KEYWORD")
      val = self.additive()
